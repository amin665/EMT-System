    ...
    public function transcribe(Request $request)
    {
        ...
        try {
           ...
           $response = (new MedicalTranscriber)->prompt(
                '"Transcribe this medical audio recording in Arabic expect English terms keep them in english. Focus on medical terms like (ضغط الدم، السكري، الحساسية). Provide a clean text output.")', 
