...
class AppointmentController extends Controller
{
    ...
    public function destroy(Appointment $appointment)
    {
        ...
        // Instead of hard delete, maybe set status to Canceled? 
        // But requirements say "canceled(remove)", usually implies delete or status change.
        // Let's stick to status change as 'Canceled' per the status Enum, 
        // OR soft delete. The enum has 'Canceled', so let's update status.
